...
namespace FileExpert.MP4.Box
{
    ...
    {
        public DataReferenceBox(TreeView treeView, TreeNode parent, DataStore dataStore, ref Int64 bitOffset) :
            base(treeView, parent, dataStore, ref bitOffset)
        {
            ...
            Result result = Utility.AddNodeContainer(Position.CHILD, parent, out nodeBox, "DataReferenceBox_payload", ItemType.SECTION1, dataStore, bitOffset, dataStore.GetLeftBitLength());
            ...
            if (result.Fine)
            {
                Utility.UpdateNodeLength(nodeBox, "DataReferenceBox_payload", ItemType.SECTION1, bitOffset - firstOffset);
            }
        }
    }
}
